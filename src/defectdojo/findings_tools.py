...
def _build_findings_filters(
    *,
    ...
    Args:
        ...
        duplicate: Optional duplicate flag filter (True/False).
...
async def get_findings(
    ...
    Args:
        ...
        status: Optional status filter.
        severity: Optional severity filter.
        duplicate: Optional duplicate flag filter. Set to ``False`` to
            exclude duplicates, ``True`` to return only duplicates.
